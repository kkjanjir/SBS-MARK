...
// ⚡ Bolt Performance Optimization: Extracted pure functions outside component to prevent recreation
...
export default function MarksheetApp() {
  ...
  // ⚡ Bolt Performance Optimization: Memoized hidden DOM computations
  // This prevents severe input lag caused by the bulk print container re-rendering on unrelated state changes
      ...
      return (
        <div key={s.id} className="marksheet-page" style={{ pageBreakAfter: index === classFilteredStudents.length - 1 ? 'auto' : 'always' }}>
          <MarksheetTemplate
            ...
            extra={s.extra_data || {}}
            coScholastic={s.extra_data?.coScholastic || {sports:'A',art:'A',music:'A',discipline:'A'}}
