...
export default function MarksheetApp() {
  ...
  // ⚡ Bolt: Memoize filtered students and bulk print elements to prevent O(N) re-renders on keystrokes
  ...
  }, [classFilteredStudents, activeTheme, showTableWatermark, subjectConfig]);
