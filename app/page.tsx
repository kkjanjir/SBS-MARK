...
export default function MarksheetApp() {
  ...
  const memoizedCalculations = useMemo(() => getCalculations(marks, activeClass), [getCalculations, marks, activeClass]);
  const { grandTotal, percentage, finalGrade } = memoizedCalculations;
