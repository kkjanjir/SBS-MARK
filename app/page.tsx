...
export default function MarksheetApp() {
  ...
  // Memoize the expensive bulk print content to prevent O(N) re-renders
  // on unrelated state changes, as hidden print containers still execute React render cycles.
  ...
  }, [classFilteredStudents, getCalculations, getClassSubjects, getClassRank, activeTheme, showTableWatermark]);
