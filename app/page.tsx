...
export default function MarksheetApp() {
  ...
  // ⚡ Bolt Optimization: Memoize the massive bulk print container
  // Why: Hidden print containers still render. Without useMemo, typing a single mark
  // causes an O(N) re-render of every student's marksheet, causing severe input lag.
  // Impact: Reduces re-renders of the print block to ~0% during data entry.
