          ...
          <div className="w-full max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => triggerPrint('bulk')} className="bg-green-600 text-white px-4 py-3 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg hover:bg-green-700 flex-1 sm:flex-none">
    ...
    <>
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          body, html { margin: 0 !important; padding: 0 !important; background: white !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          .no-print { display: none !important; }
          .print-page { width: 210mm !important; height: 296.5mm !important; overflow: hidden !important; margin: 0 auto !important; padding: 0 !important; box-sizing: border-box !important; }
        }
      `}} />
