...
// ⚡ Bolt Optimization: Extracted pure function outside component to prevent recreation on every render
...
// ⚡ Bolt Optimization: Extracted static fallback objects outside component to prevent breaking React.memo shallow equality
const defaultStudent = {};
const defaultExtra = {};
const defaultCoScholastic = { sports: 'A', art: 'A', music: 'A', discipline: 'A' };


// ⚡ Bolt Optimization: Extracted pure function outside component
...
export default function MarksheetApp() {
  ...
  // ⚡ Bolt Optimization: Memoized helper function to prevent stale closures and allow safe use in dependency arrays
  ...
  // ⚡ Bolt Optimization: Memoized filtered array to prevent recreation on every render
  const classFilteredStudents = useMemo(() => dbStudents.filter(s => s.class_name === activeClass), [dbStudents, activeClass]);
  // ⚡ Bolt Optimization: Memoized heavy DOM elements to prevent O(N) re-renders during unrelated state changes
...
// ⚡ Bolt Optimization: Wrapped in React.memo to prevent unnecessary re-renders when parent state changes
