...
// Default object constants to avoid breaking React.memo shallow equality
...
export default function MarksheetApp() {
  ...
  // Wrapped bulk marksheet generation in useMemo to prevent O(N) re-renders
  // across all hidden marksheets when unrelated states (like activeSubjectIdx) change.
  // This significantly reduces main-thread blocking and input latency.
  const bulkMarksheets = useMemo(() => {
  ...
  }, [classFilteredStudents, activeTheme, activeClass, showTableWatermark, getClassSubjects, getCalculations, getClassRank]);
