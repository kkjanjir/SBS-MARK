...
export default function MarksheetApp() {
  ...
  const defaultCoScholastic = useMemo(() => ({sports:'A',art:'A',music:'A',discipline:'A'}), []);
  ...
  }, [classFilteredStudents, activeTheme, showTableWatermark, getCalculations, getClassSubjects, getClassRank, defaultStudent, defaultExtra, defaultCoScholastic]);
