...
// 🏆 EXTRACTED STATICS & UTILS
const defaultStudent = { name: "", roll: "", mother: "", father: "", gender: "MALE" };
const defaultExtra = { attendance: "", remark: "", issueDate: "2024-03-31" };
...
export default function MarksheetApp() {
  ...
  // ⚡ OPTIMIZATION: Memoized bulk print container to prevent O(N) re-renders on typing/state changes.
  // This prevents the application from lagging when 'searchQuery' or 'accessPin' changes.
  const bulkPrintMemos = useMemo(() => {
...
// ⚡ OPTIMIZATION: Wrapped in React.memo to prevent unnecessary heavy DOM recalculations during unrelated state changes.
